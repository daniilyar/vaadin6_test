...
public class TreeTable extends TreeTableBasic {
    ...
    /**
     * This example example extends the TreeTableBasic example. The source code of TreeTableBasic can be found as its
     * own sample in the sampler
     */
    public TreeTable() {
        super();
